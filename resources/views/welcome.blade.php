				...
				<div class="row justify-content-between align-items-center">
					<div class="col-auto">
						<ul class="contact-info">
							...
							<li><a ><i class="far fa-map-marker-alt"></i> Alger , Algérie</a></li>
						</ul>
					</div>
		...
		<div class="hero-text">
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-xl-10">
						<span class="tagline wow fadeInUp" data-wow-delay="0.3s">Trouver un concentrateur  gratuitement !</span>
						<h1 class="title wow fadeInUp" data-wow-delay="0.4s">Trouver un  concentrateur d'oxygène  gratuitement !</h1>
						<a href="/search" class="main-btn wow fadeInUp" data-wow-delay="0.5s">
							Rechercher <i class="far fa-arrow-right"></i>
						</a>
					</div>
				</div>
			</div>
