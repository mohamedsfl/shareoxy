...
<body>
	...
	<section class="hero-area-one">
		<div class="hero-text">
			<img width="470px;" src="smile.png">
			<h1 style="margin-top: 25px;font-weight: bold;">Merci pour votre contribution ❤️</h1>
			<a style="margin-top: 15px;" href="/" type="button" class="btn btn-lg btn-success">Chercher des concentrateurs</a>
