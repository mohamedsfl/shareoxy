		...
		<div class="hero-text">
			<div class="container">
                        <div class="contact-form">
                            <form id="jetsky" method="POST" action="/Ajouter/run">
                            	                        	@csrf

                                <h3 class="form-title">Ajouter un concentrateur a notre database</h3>
                                <div class="row">
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-field mb-25">
                                            <label for="phone-number">Votre Numero de telephone</label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-field mb-25">
                                            <label for="subject">Wilaya</label>
                                            <input type="text" name="wilaya" id="wilaya" required>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-field mb-30">
                                            <label for="message">Détail sur votre concentrateur </label>
                                            <textarea id="detail" name="detail"  required></textarea>
                                        </div>
                                    </div>
                                    <p style="color: orange;padding-bottom: 20px;">* Un Administrateur va vérifier votre requête si elle respecte nos conditions</p>
                                    <div class="col-12">
                                        <div class="form-field">
                                            <button class="main-btn">Ajouter un concentrateur a notre database <i class="far fa-arrow-right"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
